...
export const Transactions: React.FC = () => {
  ...
  // Auto-populate wallet address from context
  useEffect(() => {
              ...
              <table style={{ width: '100%', borderCollapse: 'collapse' }}>
                ...
                <tbody>
                  {loading ? (
                    ...
                    <tr>
                      <td colSpan={6} style={{ padding: '48px', textAlign: 'center', color: 'var(--color-text-secondary)' }}>
                      ...
                      >
                        ...
                        <td style={{ padding: '16px 24px' }}>
                          <span
                            ...
                            title={transaction.walletAddress || 'No wallet address'}
                          >
                            {transaction.walletAddress ? `${transaction.walletAddress.substring(0, 10)}...` : '-'}
                          </span>
                        </td>
                        <td
                          style={{
              ...
              <div style={{ display: 'flex', gap: '12px', marginTop: '8px' }}>
                ...
                <Button 
                  ...
                  onClick={async () => {
                    ...
                    try {
                      console.log('[Frontend] Starting HTML import...');
                      console.log('[Frontend] Current walletAddress from context:', walletAddress);
                      ...
                      console.log('[Frontend] Sending payload to backend:', { userId, walletAddress: payload.walletAddress, fileName: uploadedFile.name });
